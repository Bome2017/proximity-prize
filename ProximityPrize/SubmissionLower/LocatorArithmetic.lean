...
def weightedAux : ℕ := 11463039
def weightedC : ℕ := 8187885
def weightedB : ℕ := 15829911
def fixedRegularCap : ℕ := 237171134622841770
...
theorem kernelAux_nullity :
    coefficientCount 11463039 131071 100000 18 -
      262144 * localRankBound 63 100000 18 = 2948801310715 := by
  rw [kernelAux_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    11463039 131071 100000 18 88 (by decide) (by decide)]
  decide
theorem kernelC_nullity :
    coefficientCount 8187885 131071 43759 13 -
      262144 * localRankBound 45 43759 13 = 25157355706 := by
  rw [kernelC_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    8187885 131071 43759 13 63 (by decide) (by decide)]
  decide
...
def fixedSingular : TightParameters := ⟨n, w, agreements, weightedC, 1470, 13⟩
...
theorem fixedSingular_exact : fixedSingular.countCap = 116219161506644 := by decide
theorem residualStage_exact : residualStage.regularCountCap = 777390425324962 := by decide
...
theorem ledger_exact : ledger = 239074893464388550 := by
