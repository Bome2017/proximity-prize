...
def w : ℕ := 131071
def errors : ℕ := 80171
def agreements : ℕ := 181973
def gap : ℕ := 50902
def prime : ℕ := 2130706433
def budget : ℕ := 274980727111395087
def LA : ℕ := 100000
def LB : ℕ := 1420
def weightedA : ℕ := 12738110
def weightedAux : ℕ := 11464299
def weightedC : ℕ := 8188785
def weightedB : ℕ := 15285732
def fixedRegularCap : ℕ := 273021899526170515

theorem row_values : agreements + errors = n ∧ agreements - w = gap ∧
    weightedA = 70 * agreements ∧ weightedAux = 63 * agreements ∧
    weightedC = 45 * agreements ∧ weightedB = 84 * agreements ∧ w < agreements ∧
...
theorem kernelThin_rank : localRankBound 45 100000 12 = 1059308029 := by decide
theorem kernelB_rank : localRankBound 84 1420 26 = 101150748 := by decide

theorem kernelA_nullity :
    coefficientCount 12738110 131071 100000 20 -
      262144 * localRankBound 70 100000 20 = 5212027160347 := by
  rw [kernelA_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    12738110 131071 100000 20 98 (by decide) (by decide)]
  decide
theorem kernelAux_nullity :
    coefficientCount 11464299 131071 100000 18 -
      262144 * localRankBound 63 100000 18 = 3137838780595 := by
  rw [kernelAux_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    11464299 131071 100000 18 88 (by decide) (by decide)]
  decide
theorem kernelC_nullity :
    coefficientCount 8188785 131071 100000 13 -
      262144 * localRankBound 45 100000 13 = 147260979901 := by
  rw [kernelC_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    8188785 131071 100000 13 63 (by decide) (by decide)]
  decide
theorem kernelThin_nullity :
    coefficientCount 8188785 131071 100000 12 -
      262144 * localRankBound 45 100000 12 = 6265861277 := by
  rw [kernelThin_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    8188785 131071 100000 12 63 (by decide) (by decide)]
  decide
theorem kernelB_nullity :
    coefficientCount 15285732 131071 1420 26 -
      262144 * localRankBound 84 1420 26 = 183480840 := by
  rw [kernelB_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    15285732 131071 1420 26 117 (by decide) (by decide)]
  decide

theorem C_ys60_quotient_upper :
    coefficientCount 324538 131071 99940 13 = 89812617507 := by
  rw [coefficientCount_eq_sum_range_of_weighted_cutoff
    324538 131071 99940 13 3 (by decide) (by decide)]
  decide

theorem kernelC_ys60_quotient_lt (r : ℕ) (hr : r ≤ 13) :
    coefficientCount (8188785 - (60 * 131071 - r)) 131071
      (100000 - 60) (13 - r) <
    coefficientCount 8188785 131071 100000 13 -
      262144 * localRankBound 45 100000 13 := by
  rw [kernelC_nullity]
  have hmono := RCN180.Numeric6733.coefficientCount_mono_D_s
    (D := 8188785 - (60 * 131071 - r)) (D' := 324538)
...
theorem kernelB_total_quotient_lt :
    coefficientCount 15285732 131071 2 26 <
    coefficientCount 15285732 131071 1420 26 -
      262144 * localRankBound 84 1420 26 := by
  rw [kernelB_nullity]
  decide

def fixedSingular : TightParameters := ⟨n, w, agreements, weightedC, 1417, 12⟩
def residualStage : UnequalParameters := ⟨n, w, agreements, 116, 26, LB, 97, 20, LA⟩
def residualSingular : TightParameters := ⟨n, w, agreements, weightedB, LB, 26⟩

theorem fixedSingular_exact : fixedSingular.countCap = 94776058824381 := by decide
theorem residualStage_exact : residualStage.regularCountCap = 734693960117897 := by decide
theorem residualSingular_exact : residualSingular.countCap = 872164039187364 := by decide
...
theorem ledger_exact : ledger = 274723533584300158 := by
...
def radiusNumerator : ℕ := 10261977
...
theorem score_root_integer : (2 : ℕ)^41 * 1000000^100 ≤ 1328686^100 := by decide
theorem score_radius_integer :
    (23292455 : ℕ)^128 * (2^67 * 1328686) ≤ 1000000 * 33554432^128 := by decide

theorem two_rpow_fraction_le :
    (2 : ℝ≥0)^((41 : ℝ)/100) ≤ (1328686 : ℝ≥0)/1000000 := by
  have hroot : ((2 : ℝ≥0)^(41 : ℕ))^((100 : ℝ)⁻¹) ≤ (1328686 : ℝ≥0)/1000000 := by
    rw [NNReal.rpow_inv_le_iff (by norm_num : (0 : ℝ) < 100)]
    rw [NNReal.rpow_ofNat, div_pow, le_div_iff₀ (by positivity)]
    exact_mod_cast score_root_integer
  calc
    (2 : ℝ≥0)^((41 : ℝ)/100) = ((2 : ℝ≥0)^(41 : ℕ))^((100 : ℝ)⁻¹) := by
...
theorem radius_power_bound :
    (1 - radius)^IRSProfile.repetitions ≤
      ((1 : ℝ≥0)/2^(67 : ℕ)) * (1000000/1328686) := by
  have hsub : (1 - radius : ℝ≥0) = 23292455/33554432 := by
    have hr : radius ≤ 1 := by
    ...
    norm_num [radius, claimedRadius, radiusNumerator, radiusDenominator]
  change (1 - radius)^128 ≤ ((1 : ℝ≥0)/2^(67 : ℕ)) * (1000000/1328686)
  rw [hsub, div_pow, div_mul_div_comm, one_mul,
    div_le_div_iff₀ (by positivity) (by positivity)]
  exact_mod_cast score_radius_integer

theorem score_target_le :
    (1 - radius)^IRSProfile.repetitions ≤ claimedError 6741 := by
  have hscale : (1000000 : ℝ≥0)/1328686 ≤ (2 : ℝ≥0)^(-((41 : ℝ)/100)) := by
    calc
      (1000000 : ℝ≥0)/1328686 = 1/((1328686 : ℝ≥0)/1000000) := by norm_num
      _ ≤ 1/((2 : ℝ≥0)^((41 : ℝ)/100)) :=
        one_div_le_one_div_of_le (by positivity) two_rpow_fraction_le
      _ = _ := by rw [one_div, NNReal.rpow_neg]
  calc
    (1 - radius)^IRSProfile.repetitions ≤
        ((1 : ℝ≥0)/2^(67 : ℕ)) * (1000000/1328686) := radius_power_bound
    _ ≤ ((1 : ℝ≥0)/2^(67 : ℕ)) * (2 : ℝ≥0)^(-((41 : ℝ)/100)) :=
      mul_le_mul_of_nonneg_left hscale (by positivity)
    _ = claimedError 6741 := by
      unfold claimedError
      rw [show -((((6741 : ℕ) : ℝ)/100)) =
          -((67 : ℕ) : ℝ) + -((41 : ℝ)/100) by norm_num,
