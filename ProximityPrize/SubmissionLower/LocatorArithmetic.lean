...
def fixedRegularCap : ℕ := 241613533669933335
...
theorem kernelA_rank : localRankBound 74 110000 21 = 5197898453 := by decide
...
theorem kernelA_nullity :
    coefficientCount 13463782 131071 110000 21 -
      262144 * localRankBound 74 110000 21 = 6776939096664 := by
  rw [kernelA_rank, coefficientCount_eq_sum_range_of_weighted_cutoff
    13463782 131071 110000 21 103 (by decide) (by decide)]
  decide
...
def residualStage : UnequalParameters := ⟨n, w, agreements, 120, 27, LB, 102, 21, LA⟩
...
theorem residualStage_exact : residualStage.regularCountCap = 874095391362982 := by decide
...
theorem ledger_exact : ledger = 243634911618861319 := by
