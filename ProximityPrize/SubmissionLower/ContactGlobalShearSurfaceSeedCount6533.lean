...
/-!
# Agreement-first whole-surface count for the 65.33 global shear
...
/-- Sharp agreement caps for the 65.33 interpolating surface. -/
theorem sharp_agreement_caps
  ...
  · simpa [agreementPolynomial, HasCaps, capAt, sharpAgreement,
      ContactCountingCaps.agreementCaps, ContactCountingCaps.capAt] using hold 2

/-- Exact 65.33 whole-surface wrapper. -/
theorem whole_surface_seed_bound_fixed
  ...
  have hcap (i : ι) := sharp_agreement_caps phi F hbox hY hR hZ
    (x i) (u0 i) (u1 i)
