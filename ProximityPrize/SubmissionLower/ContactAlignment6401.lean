...
/-!
# Unconditional alignment at 77701 errors with seed budget 10^17
...
theorem interpolant_selected_count6401 : InterpolantSelectedCount6401 := by
  ...
  intro Q hQ hbox hY selected seeds u₀ u₁ hdegree hsolution hagreement hnoPencil
  exact global_selected_count IRSProfile.Field Q hQ hbox hY selected seeds
...
theorem alignment6401 :
    AffineLineAlignmentBound IRSProfile.baseCode 77701 100000000000000000 :=
