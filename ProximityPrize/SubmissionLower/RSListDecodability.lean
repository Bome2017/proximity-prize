...
Port of ArkLib ReedSolomon.ListDecodability (ACFY24 Thm 4.3) into the
SubmissionLower import closure. Original authors: Ilia Vlasov, Aristotle (Harmonic).
-/

import ProximityPrize.Benchmark.TargetLower

open Finset ReedSolomon Code
open scoped NNReal
