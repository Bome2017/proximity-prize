...
/-!
# Actual universal vanishing interpolant at the 65.33 row
...
vanishing statement at 184,027 agreements.
-/
...
node is divisible by the required order-19 contact power. -/
...
/-- The same nonzero order-19 interpolant vanishes after specialization for
every degree-`w` polynomial agreeing on at least 184,027 nodes. -/
