...
theorem exists_frozen_translated_contact_interpolant
    ...
    ∃ Q : MvPolynomial (Fin 4) IRSProfile.Field,
      Q ≠ 0 ∧ Q ∈ globalCoefficientBox IRSProfile.Field 2406287 131071 225 3 ∧
  ...
  exact all_blocks_divisible_of_equations IRSProfile.Field 2406287 131071 225 3 13
...
theorem exists_frozen_universal_vanishing_interpolant
    ...
    ∃ Q : MvPolynomial (Fin 4) IRSProfile.Field,
      ...
      ∀ (γ : IRSProfile.Field) (P : Polynomial IRSProfile.Field)
        ...
        P.natDegree ≤ 131071 → 185099 ≤ support.card →
  ...
  · have hdegree := specialization_natDegree_lt IRSProfile.Field
      2406287 131071 225 3 Q P γ (by decide) hcaps hP
    have hbound : 2406287 ≤ 13 * support.card := by omega
