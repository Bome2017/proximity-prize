...
/- Scalar interpolation certificate for 80171 errors.
   The Y+R cap is 62, with multiplicity 45 for the 181973-agreement
...
theorem coefficient_count_exact :
   coefficientCount weightedCap w yTotalCap slopeCap = 2777618636 := by decide
theorem local_rank_exact :
   localRankBound multiplicity yTotalCap slopeCap = 10595 := by decide
theorem nullity_exact :
   coefficientCount weightedCap w yTotalCap slopeCap -
     n*localRankBound multiplicity yTotalCap slopeCap = 202956 := by
...
theorem list_numeric_values :
   agreements=181973 ∧ gap=50902 ∧ weightedCap=8188785 ∧
   singularListCap=1426 ∧ listNumerator=50062212958390 ∧
   listNumerator/gap+1=983501886 ∧
   listNumerator<983501886*gap ∧ 983501886<listBudget := by decide
