...
def mcaBudget:ℕ:=274980727078395087
...
theorem protocolClaim6742_of_alignment
   (halign:AffineLineAlignmentBound IRSProfile.baseCode errors mcaBudget):
   ProtocolClaim 6742 10263295 33554432 where
 ...
 score:=by
   change (1 - LocatorArithmetic.radius) ^
     IRSProfile.repetitions≤claimedError 6742
