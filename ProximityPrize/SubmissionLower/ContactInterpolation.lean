...
abbrev FrozenCoefficientIndex := CoefficientIndex 3320622 131071 174 5
    ...
    ∃ θ : FrozenCoefficientIndex → IRSProfile.Field, θ ≠ 0 ∧
      ∀ (i : IRSProfile.Index) (r : Fin 18),
        contactJet IRSProfile.Field (18 - r.val)
          ((extractBlock IRSProfile.Field 3320622 131071 174 5
            (IRSProfile.domain i) (u₀ i) (u₁ i) r.val θ) : Poly IRSProfile.Field) = 0 := by
  apply exists_nonzero_block_equations IRSProfile.Field 3320622 131071 174 5 18
...
theorem exists_frozen_nonzero_polynomial_and_equations
    ...
    ∃ (Q : MvPolynomial (Fin 4) IRSProfile.Field)
      ...
      Q ≠ 0 ∧
      Q ∈ globalCoefficientBox IRSProfile.Field 3320622 131071 174 5 ∧
      Q = reconstruct IRSProfile.Field 3320622 131071 174 5 θ ∧
      ∀ (i : IRSProfile.Index) (r : Fin 18),
        contactJet IRSProfile.Field (18 - r.val)
          ((extractBlock IRSProfile.Field 3320622 131071 174 5
            (IRSProfile.domain i) (u₀ i) (u₁ i) r.val θ) : Poly IRSProfile.Field) = 0 := by
  obtain ⟨θ, hθ, hconstraints⟩ := exists_frozen_nonzero_contact_array u₀ u₁
  exact ⟨reconstruct IRSProfile.Field 3320622 131071 174 5 θ, θ,
    reconstruct_ne_zero IRSProfile.Field 3320622 131071 174 5 θ hθ,
    reconstruct_mem_globalCoefficientBox IRSProfile.Field 3320622 131071 174 5 θ,
    rfl, hconstraints⟩
