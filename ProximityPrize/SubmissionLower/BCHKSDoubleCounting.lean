...
/- The retired coarse concrete bounds and affine-finish lemma below are not in
the submitted import closure's declaration dependency graph.  Keep the generic
incidence lemma above and elaborate only the exact-capacity specialization
below. -/
/-
