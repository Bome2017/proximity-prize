...
namespace ProximityPrize.SubmissionLower.ContactMovingStackedInterpolation6731Research
...
open ContactMovingParameters6731Research ContactStackedGCDCover6670Research
...
theorem exists_stacked_universal_vanishing_interpolants
  ...
  have hgateA : Fintype.card IRSProfile.Index * localRankBound 42 22328 11 <
      coefficientCount (42 * agreements) w 22328 11 := by
  ...
  have hgateB : Fintype.card IRSProfile.Index * localRankBound 78 1205 24 <
      coefficientCount (78 * agreements) w 1205 24 := by
    rw [show Fintype.card IRSProfile.Index = n by
      norm_num [IRSProfile.Index, n]]
    change profileB.totalRank < profileB.coefficients
    exact interpolation_gates.2.1
  have hgateC : Fintype.card IRSProfile.Index * localRankBound 40 27619 12 <
      coefficientCount (40 * agreements) w 27619 12 := by
    rw [show Fintype.card IRSProfile.Index = n by
      norm_num [IRSProfile.Index, n]]
  ...
  have hA := nonzero_kernel_member_universal IRSProfile.Field
    (42 * agreements) w 22328 11 42 agreements IRSProfile.domain u0 u1 thetaA
    hthetaA (LinearMap.mem_ker.mpr hkernelA) hDA rfl
  have hB := nonzero_kernel_member_universal IRSProfile.Field
    (78 * agreements) w 1205 24 78 agreements IRSProfile.domain u0 u1 thetaB
    hthetaB (LinearMap.mem_ker.mpr hkernelB) hDB rfl
  have hC := nonzero_kernel_member_universal IRSProfile.Field
    (40 * agreements) w 27619 12 40 agreements IRSProfile.domain u0 u1 thetaC
    hthetaC (LinearMap.mem_ker.mpr hkernelC) hDC rfl
  have hOrdA := flag_box_to_ordinary IRSProfile.Field
    (42 * agreements) w 22328 11 _ hA.2.1
  have hOrdB := flag_box_to_ordinary IRSProfile.Field
    (78 * agreements) w 1205 24 _ hB.2.1
  have hOrdC := flag_box_to_ordinary IRSProfile.Field
    (40 * agreements) w 27619 12 _ hC.2.1
  refine ⟨reconstruct IRSProfile.Field (42 * agreements) w 22328 11 thetaA,
    reconstruct IRSProfile.Field (78 * agreements) w 1205 24 thetaB,
    reconstruct IRSProfile.Field (40 * agreements) w 27619 12 thetaC,
...
end ProximityPrize.SubmissionLower.ContactMovingStackedInterpolation6731Research
