...
theorem bchksLinearProtocolAdapter
    ...
    (hWeighted : ∀ j a, ((R.coeff j).coeff a) ≠ 0 →
      a + 131071 * j < 33398999)
    (hRdeg : R.natDegree = 1)
    (hTmargin : (76594 + 1) + 2 * 33398999 * 63302 < T.card) :
  ...
  have hTgood : 76594 + 1 < Tgood.card := by omega
  have hlarge : 2 * 33398999 + 76594 + 1 ≤ Tgood.card := by
