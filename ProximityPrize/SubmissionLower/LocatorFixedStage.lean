...
/- Factor-adapted stage count for the 80171-error row.
...
def identitySlackZ (b s : ℕ) : ℕ :=
  6361886697054760 + 6995970984247296 * b + 11237237678086996 * s +
    3497985492123648 * s ^ 2 + 6995970984247296 * b * s
def identitySlackYZ (a b s : ℕ) : ℕ :=
  2229790230328996 + 6995970984247296 * a + 6995970984247296 * b +
    8482506700269820 * s + 3497985492123648 * s ^ 2 +
    6995970984247296 * a * s + 6995970984247296 * b * s
def identitySlackAll (a b s : ℕ) : ℕ :=
  2973050415326838 + 11237237678086996 * a + 8482506700269820 * b +
    3497985492123648 * b ^ 2 + 8482506700269820 * s +
    3497985492123648 * s ^ 2 + 6995970984247296 * a * b +
    6995970984247296 * a * s + 6995970984247296 * b * s
...
theorem flag_characteristic (a b s : ℕ) (flag : FlagDegree)
    (hS : s + 2 ≤ 12) (hY : b + s + 3 ≤ 59) (hT : a + b + s + 3 ≤ 1417)
