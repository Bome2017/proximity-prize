...
/- Existing asymmetric residual counting, now with the 80171-error row.
...
theorem residual_count_lt
    ...
    (hbox : Q ∈ globalCoefficientBox K (84 * agreements) w 1420 26)
  ...
  apply asymmetric_stage_count_lt_of_regular_factors
    ...
    (by change 1 ≤ 26; decide) (by change 26 < 2130706433; decide)
    ...
    (by change 131071 < 181973; decide) (by change 181973 ≤ 262144; decide)
    ...
    valid.qY (by change 26 ≤ 26; decide) (by exact Nat.le_refl _)
  ...
  exact all_regularPairSeeds_bound residualStage Q T hQ hrel
    (84 * agreements) w 1420 26 2130706433 hbox (by decide)
    valid.qY (by change 26 ≤ 26; decide) (by exact Nat.le_refl _)
    hTcaps.1 hTcaps.2.1 hTcaps.2.2 (by change 1 ≤ 26; decide)
    (by change 116 < 2130706433; decide) (by change 26 < 2130706433; decide)
...
theorem gcd_residual_count_lt
  ...
  have hQflag := quotient_mem_flagGlobalCoefficientBox_of_mul_eq
    QB H Q (84 * agreements) w 1420 26 0 0 0 hQB hH hQ hboxB hQeq
  ...
  have hTflag := quotient_mem_flagGlobalCoefficientBox_of_mul_eq
    ...
    (Nat.zero_le _) (Nat.zero_le _) (Nat.zero_le _)
  have hQbox : Q ∈ globalCoefficientBox K (84 * agreements) w 1420 26 :=
    RCN101.flag_box_to_ordinary K
      (84 * agreements) w 1420 26 Q (by simpa only [Nat.sub_zero] using hQflag)
