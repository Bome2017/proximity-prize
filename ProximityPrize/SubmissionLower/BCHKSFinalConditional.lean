...
is compiled with the optimized score `63.79`. -/
theorem protocolClaim6379_of_polynomialAlignment
    (halg : ProximityPrize.SubmissionLower.BCHKSPolynomialAlignment) :
    ProtocolClaim 6379 306280 1048576 where
  admissible := by
    constructor <;>
  ...
  reduction := by
    ...
    have hr : claimedRadius 306280 1048576 =
