...
is compiled with the optimized score `63.81`. -/
theorem protocolClaim6392_of_polynomialAlignment
    (halg : ProximityPrize.SubmissionLower.BCHKSPolynomialAlignment) :
    ProtocolClaim 6392 306815 1048576 where
  admissible := by
    constructor <;>
  ...
  reduction := by
    ...
    have hr : claimedRadius 306815 1048576 =
